...
?>
  <p>
    ...
    <span id="prettyphoto-thumbcrop-span">
      <input type="checkbox" id="prettyphoto-thumbcrop" name="prettyphoto-thumbcrop" value="1" <?php echo @$gallery['thumbcrop'] ? 'checked="checked"' : ''; ?> style="vertical-align:middle"/> 
  ...
  <p>
    ...
    <span id="prettyphoto-crop-span">
      <input type="checkbox" id="prettyphoto-crop" name="prettyphoto-crop" value="1" <?php echo @$gallery['crop'] ? 'checked="checked"' : ''; ?> style="vertical-align:middle"/> 
      <?php i18n('i18n_gallery/CROP'); ?>
    </span>
  </p>
  <p class="inline">
