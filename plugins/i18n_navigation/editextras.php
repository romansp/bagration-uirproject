...
?>
  ...
  function changeUrl() {
    ...
    if ($('div.leftopt').size() > 0) { // GetSimple 3.0+
      ...
      $('#post-parent').closest('p').attr('style','display:'+(hide?'none':'block'));
      $('#post-private').closest('p').attr('style','display:'+(hide?'none':'inline'));
      $('#post-template').closest('p').attr('style','display:'+(hide?'none':'block'));
      $('#post-menu-order').attr('style','display:'+(hide?'none':'inline'));
      $('#post-menu-order').prev().attr('style','display:'+(hide?'none':'block'));
    } else {
      if (url.indexOf('_') >= 0) {
